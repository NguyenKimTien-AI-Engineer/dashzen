...
| `dashboard-builder` | Apply spec/layout/binding changes to `page.tsx` |
...
| Change colors, labels, chart type in code | `dashboard-builder` only | Single |
...
spawn_agent("dashboard-builder", "Update page.tsx: <change>. Read spec.md, bindings.md, layout.md, page.tsx. Preserve <!-- builder --> marker.")
